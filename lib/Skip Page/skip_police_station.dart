...
class SkipPoliceStation extends StatefulWidget {
  const SkipPoliceStation({Key? key}) : super(key: key);

  @override
  State<SkipPoliceStation> createState() => _SkipPoliceStation();
}

class _SkipPoliceStation extends State<SkipPoliceStation> {
